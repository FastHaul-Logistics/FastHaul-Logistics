 // Make sure to run npm install quickchart-js first
 // You can learn more here https://quickchart.io/documentation/
 // Credit: 0861#0862
 ...
 module.exports = {
     data: new SlashCommandBuilder()
         .setName('compteur-membre')
         .setDescription('Obtenir le nombre de membres du serveur')
