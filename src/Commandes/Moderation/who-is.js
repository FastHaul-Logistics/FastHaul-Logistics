...
module.exports = {
    ...
    .addUserOption(option => option.setName('user').setDescription("L’utilisateur que vous ciblez.").setRequired(false))
    .setDescription('Obtenir les informations d’un utilisateur au sein de votre guilde!'),
